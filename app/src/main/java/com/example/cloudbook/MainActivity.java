...
import com.example.cloudbook.auth.Login;
import com.example.cloudbook.auth.Register;
import com.example.cloudbook.model.Note;
import com.example.cloudbook.note.AddNote;
import com.example.cloudbook.note.EditNote;
import com.example.cloudbook.note.NoteDetails;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            ...
            case R.id.notes:
                Toast.makeText(this, "Use sync notes to login; add notes too add note.", Toast.LENGTH_SHORT).show();
                break;
